...
int main() {
	...
	char placa[20], cedula[12], tipo[VEHICULOS_MAX], placaBusqueda[20];
		...
		if (existencia == 1){
			...
			do {
				...
				case 1:
					...
					do{
						printf("Ingrese el avalúo (hasta $200000):");
				...
				case 2:
					...
					if (placaEncontrada == -1) {
						printf("Vehiculo con placa '%s' no encontrado, saldra al menu principal.\n", placaBusqueda);
						break;
					} else {
						...
						do{
							...
							if (respuesta[0] == 's' || respuesta[0] == 'S'){
								...
								while (getchar() != '\n');
								printf("\n=======================================\n");
								guardarDatosVehiculares(listaVehicular, &matricula, placaEncontrada, totalMatricula);
								printf("=======================================\n");
								printf("Presione Enter...");
								while (getchar() != '\n');
								system("cls");
			...
			do{
				...
				if (respuesta1[0] == 's' || respuesta1[0] == 'S') {
					system("cls");
					printf("\n=================================\n");
					...
					while(getchar() != '\n');
					system("cls");
				} else if (respuesta1[0] == 'n' || respuesta1[0] == 'N'){
					system("cls");
					printf("\n=================================\n");
			...
			} while(respuesta1[0] != 's' || respuesta1[0] != 'S' || respuesta1[0] != 'n' || respuesta1[0] != 'N');
		}
	}
	return 0;
}
